			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2000 2000">
				<defs>
					<defs>
						<clipPath id="myClip">
							<polygon
								points={`0 0,2000 0,2000 1100,1200 1100,1200 ${1135 + height},2000
				...
				<title>yellow</title>
				<g id="Layer_2" data-name="Layer 2" clip-path="url(#myClip)">
					<rect x="1140.8" y="1731.73" width="693.33" height="164.27" fill="#ffc000" />
					<rect x="1965.33" y="413.69" width="34.67" height="112.36" fill="#ffc000" />
					<rect y="1451.73" width="34.93" height="112.27" fill="#ffc000" />
					<rect y="1980.8" width="2000" height="19.2" fill="#ffc000" />
					<rect x="1716.27" y="1731.73" width="164.27" height="164.27" fill="#fff" />
